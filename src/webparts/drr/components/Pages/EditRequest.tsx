...
export const EditRequest: React.FunctionComponent<IDrrProps> = (props: IDrrProps) => {
  ...
  let BrandText: any;
    ...
    async function onRequestInitiate(formValues: any) {
        ...
        await spCrudObj.updateData("WeeklyDiesel", workrequestColl[0].Id, PRRequest, props).then(async (brrAppUpdateResult1) => {

        alert ("Weekly Diesel data updated successfully")
            ...
            <div>
              {
                React.useEffect(() => {                 
                  ...
                  // formik.setFieldValue('ProjectCodeId', workrequestColl != undefined ? workrequestColl[0].ProjectCodeId : undefined);
                  formik.setFieldValue('Receipt', workrequestColl != undefined ? workrequestColl[0].Receipt : undefined);
                  formik.setFieldValue('ReceiptLocal', workrequestColl != undefined ? workrequestColl[0].ReceiptLocalfromAuthorisedPump : undefined);
                  formik.setFieldValue('Issue', workrequestColl != undefined ? workrequestColl[0].IssueOwnconsumption : undefined);
                  formik.setFieldValue('IssueChargeable', workrequestColl != undefined ? workrequestColl[0].IssueChargeable : undefined);
                  formik.setFieldValue('Closing', workrequestColl != undefined ? workrequestColl[0].Closing : undefined);
                  formik.setFieldValue('Opening', workrequestColl != undefined ? workrequestColl[0].Opening : undefined);
