...
export interface ISPCRUDOPS {
    ...
    addAttchmentInList(data: File, listName: string, itemId: number, fileName: string, props: IItProps): Promise<any>;
    }
...
export default async function SPCRUDOPS(): Promise<ISPCRUDOPS> {
    ...
    const getData = async (listName: string, columnsToRetrieve: string, columnsToExpand: string, filters: string, orderby: {column: string, isAscending: boolean}, props: IItProps) => {
...
//Get All Group Name from Site
    ...
    const getTopData = async (listName: string, columnsToRetrieve: string, columnsToExpand: string, filters: string, orderby: { column: string, isAscending: boolean }, top: number, props: IItProps) => {
        let web = Web(props.currentSPContext.pageContext.web.absoluteUrl);
    ...
    //     });
    // };
    const addAttchmentInList = async (file: File, listName: string, itemId: number, fileName: string, props: IItProps) => {
        let web = Web(props.currentSPContext.pageContext.web.absoluteUrl);
