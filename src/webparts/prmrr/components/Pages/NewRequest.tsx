...
export const NewRequest: React.FunctionComponent<IPrmrrProps> = (props: IPrmrrProps) => {
  ...
  async function onRequestInitiate(formValues: any) {
    ...
    await spCrudObj.insertData("PendingRejectedMaterial", PRRequest, props).then(async (brrInsertResult) => {
      alert("Pending Rejected Material details submitted successfully");
