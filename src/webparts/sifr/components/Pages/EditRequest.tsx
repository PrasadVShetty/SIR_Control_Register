...
export const EditRequest: React.FunctionComponent<ISifrProps> = (props: ISifrProps) => {
  ...
  const [workrequestColl, setPedningdata] = useState<IDRRMaster[]>();
  ...
  async function onRequestInitiate(formValues: any) {
    ...
    await spCrudObj.updateData("StoresInfra", workrequestColl[0].Id, PRRequest, props).then(async (brrAppUpdateResult1) => {

      alert("Stores Infrastructure data updated successfully")
  ...
  React.useEffect(() => {
    const fetchData = async () => {
      try {
        const approvemasterres = await IDRRRequestsOps().getDRRDatafilter(ArtIntId, props);
          ...
          <div>
            {
              React.useEffect(() => {
                ...
                if (workrequestColl && workrequestColl[0]?.ProjectCodeId) {
                  formik.setFieldValue('ProjectCodeId', workrequestColl[0]?.ProjectCodeId);
                }
                ...
                formik.setFieldValue('ClosedStorageStatus', workrequestColl != undefined ? workrequestColl[0].CLOSEDSTORAGEStatus : undefined);
                formik.setFieldValue('LubesStorageStatus', workrequestColl != undefined ? workrequestColl[0].LUBESSTORAGEStatus : undefined);
                formik.setFieldValue('GasesStorageStatus', workrequestColl != undefined ? workrequestColl[0].GASESSTORAGEOPENSHEDStatus : undefined);
                formik.setFieldValue('WeightBridgeStatus', workrequestColl != undefined ? workrequestColl[0].WEIGHTBRIDGEStatus : undefined);
                formik.setFieldValue('SteelYardStatus', workrequestColl != undefined ? workrequestColl[0].STEELYARDStatus : undefined);
                formik.setFieldValue('ClosedStorage', workrequestColl != undefined ? workrequestColl[0].CLOSEDSTORAGE : undefined);
                formik.setFieldValue('LubesStorage', workrequestColl != undefined ? workrequestColl[0].LUBESSTORAGE : undefined);
                formik.setFieldValue('GasesStorage', workrequestColl != undefined ? workrequestColl[0].GASESSTORAGEOPENSHED : undefined);
                formik.setFieldValue('WeightBridge', workrequestColl != undefined ? workrequestColl[0].WEIGHTBRIDGE : undefined);
                formik.setFieldValue('SteelYard', workrequestColl != undefined ? workrequestColl[0].STEELYARD : undefined);
                formik.setFieldValue('CurrentMonthOpeningQty', workrequestColl != undefined ? workrequestColl[0].CurrentMonthOpeningQty : undefined);
                formik.setFieldValue('CurrentMonthRecdQty', workrequestColl != undefined ? workrequestColl[0].CurrentMonthRecdQty : undefined);
                formik.setFieldValue('CurrentMonthSoldQty', workrequestColl != undefined ? workrequestColl[0].CurrentMonthSoldQty : undefined);
                formik.setFieldValue('CurrentMonthOpeningQtyStatus', workrequestColl != undefined ? workrequestColl[0].CurrentMonthOpeningQtyStatus : undefined);
                formik.setFieldValue('CurrentMonthRecdQtyStatus', workrequestColl != undefined ? workrequestColl[0].CurrentMonthRecdQtyStatus : undefined);
                formik.setFieldValue('CurrentMonthSoldQtyStatus', workrequestColl != undefined ? workrequestColl[0].CurrentMonthSoldQtyStatus : undefined);
                formik.setFieldValue('ScrapSoldOutQty', workrequestColl != undefined ? workrequestColl[0].ScrapSoldOutQtyuptopreviousMonth0 : undefined);
                formik.setFieldValue('ScrapSoldOutValue', workrequestColl != undefined ? workrequestColl[0].ScrapSoldOutValueINRexclTaxuptop0 : undefined);
                formik.setFieldValue('CurrentMonthScrapSoldValue', workrequestColl != undefined ? workrequestColl[0].CurrentMonthScrapSoldValueINRexc0 : undefined);
                formik.setFieldValue('ScrapSoldOutQtyStatus', workrequestColl != undefined ? workrequestColl[0].ScrapSoldOutQtyuptopreviousMonth : undefined);
                formik.setFieldValue('ScrapSoldOutValueStatus', workrequestColl != undefined ? workrequestColl[0].ScrapSoldOutValueINRexclTaxuptop : undefined);
                formik.setFieldValue('CurrentMonthScrapSoldValueStatus', workrequestColl != undefined ? workrequestColl[0].CurrentMonthScrapSoldValueINRexc : undefined);
              }, [workrequestColl])
            }
            <div>
