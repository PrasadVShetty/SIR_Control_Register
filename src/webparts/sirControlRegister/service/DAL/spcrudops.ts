...
export interface ISPCRUDOPS {
    getData(listName: string, columnsToRetrieve: string, columnsToExpand: string, filters: string
        , orderby: { column: string, isAscending: boolean}, props: ISirControlRegisterProps): Promise<any>;
    insertData(listName: string, data: any, props: ISirControlRegisterProps): Promise<any>;
    updateData(listName: string, itemId: number, data: any, props: ISirControlRegisterProps): Promise<any>;
    deleteData(listName: string, itemId: number, props: ISirControlRegisterProps): Promise<any>;
    getListInfo(listName: string, props: ISirControlRegisterProps): Promise<any>;
    getListData(listName: string, columnsToRetrieve: string, props: ISirControlRegisterProps): Promise<any>;
    batchInsert(listName: string, data: any, props: ISirControlRegisterProps): Promise<any>;
    batchUpdate(listName: string, data: any, props: ISirControlRegisterProps): Promise<any>;
    batchDelete(listName: string, data: any, props: ISirControlRegisterProps): Promise<any>;
    createFolder(listName: string, folderName: string, props: ISirControlRegisterProps):Promise<any>;
    uploadFile(folderServerRelativeUrl: string, file: File, props: ISirControlRegisterProps): Promise<any>;
    deleteFile(fileServerRelativeUrl: string, props: ISirControlRegisterProps): Promise<any>;
    currentProfile(props: ISirControlRegisterProps): Promise<any>;
    //currentUserProfile(props: IDeviationuatProps): Promise<any>;
    getLoggedInSiteGroups(props: ISirControlRegisterProps): Promise<any>;
    getAllSiteGroups(props: ISirControlRegisterProps): Promise<any>;
    getTopData(listName: string, columnsToRetrieve: string, columnsToExpand: string, filters: string
        , orderby: { column: string, isAscending: boolean }, top: number, props: ISirControlRegisterProps): Promise<any>;
    addAttchmentInList(data: File, listName: string, itemId: number, fileName: string, props: ISirControlRegisterProps): Promise<any>;
    }
...
export default async function SPCRUDOPS(): Promise<ISPCRUDOPS> {
    ...
    const getData = async (listName: string, columnsToRetrieve: string, columnsToExpand: string, filters: string, orderby: {column: string, isAscending: boolean}, props: ISirControlRegisterProps) => {
        let web = Web(props.currentSPContext.pageContext.web.absoluteUrl);
        const items: any[] = await web.lists.getByTitle(listName).items.select(columnsToRetrieve).expand(columnsToExpand).filter(filters).orderBy(orderby.column, orderby.isAscending).getAll();
        return items;
    };

    const insertData = async (listName: string, data: any, props: ISirControlRegisterProps) => {
        let web = Web(props.currentSPContext.pageContext.web.absoluteUrl);
    ...
    const updateData = async (listName: string, itemId: number, data: any, props: ISirControlRegisterProps) => {
        let web = Web(props.currentSPContext.pageContext.web.absoluteUrl);
    ...
    const deleteData = async (listName: string, itemId: number, props: ISirControlRegisterProps) => {
        let web = Web(props.currentSPContext.pageContext.web.absoluteUrl);
    ...
    const getListInfo = async (listName: string, props: ISirControlRegisterProps) => {
        let web = Web(props.currentSPContext.pageContext.web.absoluteUrl);
    ...
    const getListData = async (listName: string, columnsToRetrieve: string, props: ISirControlRegisterProps) => {
        let web = Web(props.currentSPContext.pageContext.web.absoluteUrl);
    ...
    const batchInsert = async (listName: string, data: any, props: ISirControlRegisterProps) => {
        let web = Web(props.currentSPContext.pageContext.web.absoluteUrl);
    ...
    const batchUpdate = async (listName: string, data: any, props: ISirControlRegisterProps) => {
        let web = Web(props.currentSPContext.pageContext.web.absoluteUrl);
        let list = web.lists.getByTitle(listName);
        const entityTypeFullName = await list.getListItemEntityTypeFullName();
        let batch = web.createBatch();
    ...
    const batchDelete = async (listName: string, data: any, props: ISirControlRegisterProps) => {
        let web = Web(props.currentSPContext.pageContext.web.absoluteUrl);
        let list = web.lists.getByTitle(listName);
       // const entityTypeFullName = await list.getListItemEntityTypeFullName();
        let batch = web.createBatch();
    ...
    const createFolder = async (listName: string, folderName: string, props: ISirControlRegisterProps) => {
        let web = Web(props.currentSPContext.pageContext.web.absoluteUrl);
    ...
    const uploadFile = async (folderServerRelativeUrl: string, file: File, props: ISirControlRegisterProps) => {
    ...
    const deleteFile = async (fileServerRelativeUrl: string, props: ISirControlRegisterProps) => {
        Logger.subscribe(new ConsoleListener());
        Logger.activeLogLevel = LogLevel.Verbose;
...
return avatar;
   ...
   //Current User Belongs which Site Group    
    const getLoggedInSiteGroups = async (props: ISirControlRegisterProps) => {
        //let web = Web(props.currentSPContext.pageContext.web.absoluteUrl);
        let web = Web(props.currentSPContext.pageContext.web.absoluteUrl);
...
//Get All Group Name from Site
    ...
    const getTopData = async (listName: string, columnsToRetrieve: string, columnsToExpand: string, filters: string, orderby: { column: string, isAscending: boolean }, top: number, props: ISirControlRegisterProps) => {
        let web = Web(props.currentSPContext.pageContext.web.absoluteUrl);
    ...
    //     });
    // };
    const addAttchmentInList = async (file: File, listName: string, itemId: number, fileName: string, props: ISirControlRegisterProps) => {
        let web = Web(props.currentSPContext.pageContext.web.absoluteUrl);
