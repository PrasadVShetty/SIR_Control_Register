...
export const EditRequest: React.FunctionComponent<ISrProps> = (props: ISrProps) => {
  ...
  async function onRequestInitiate(formValues: any) {
    ...
    await spCrudObj.updateData("ScrapReport", workrequestColl[0].Id, PRRequest, props).then(async (brrAppUpdateResult1) => {

      alert("Scrap Report data updated successfully")
          ...
          <div>
            {
              React.useEffect(() => {
                ...
                formik.setFieldValue('TypeOfItem', workrequestColl != undefined ? workrequestColl[0].TypeofItemId : undefined);
                formik.setFieldValue('ItemDescription', workrequestColl != undefined ? workrequestColl[0].ItemDescription : undefined);
                formik.setFieldValue('UOM', workrequestColl != undefined ? workrequestColl[0].UOM : undefined);
                formik.setFieldValue('ConsumedQtyPrevMonth', workrequestColl != undefined ? workrequestColl[0].NewConsumedQtyuptopreviousMonthsinceinception : undefined);
                formik.setFieldValue('RecdQtyPrevMonth', workrequestColl != undefined ? workrequestColl[0].RecdQtyUpTopreviousMonthsinceinception : undefined);
                formik.setFieldValue('ScrapSoldQtyPrevMonth', workrequestColl != undefined ? workrequestColl[0].ScrapSoldOutQtyuptopreviousMonthsinceinception : undefined);
                formik.setFieldValue('ScrapSoldValuePrevMonth', workrequestColl != undefined ? workrequestColl[0].ScrapSoldOutValue : undefined);
                ...
                formik.setFieldValue('CurrentMonthScrapSoldValue', workrequestColl != undefined ? workrequestColl[0].CurrentMonthScrapSoldValueINRexclTax : undefined);
                formik.setFieldValue('TotalRecdQty', workrequestColl != undefined ? workrequestColl[0].TotalRecdQty : undefined);
                formik.setFieldValue('TotalSold', workrequestColl != undefined ? workrequestColl[0].TotalSold : undefined);
                formik.setFieldValue('ScrapAvailable', workrequestColl != undefined ? workrequestColl[0].ScrapAvailable : undefined);
                formik.setFieldValue('TotalSoldOutValue', workrequestColl != undefined ? workrequestColl[0].TotalSoldOutValueINRexclTax : undefined);                                
              }, [workrequestColl])
            }
            <div>
